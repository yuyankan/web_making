...
function mybar1() {
        ...
        mybar1_data_draw("summary_error_20230413_08_05_54.csv", bar_platform.value, bar_software.value, weeks_selected);
...
function draw_bar1(data_object, date_week){
    ...
    option_cur = {
       ...
       //-------------   x轴   -------------------
        ...
        series: [
            ...
            data: bar1_datas[0],//数据，数据中其他属性，查阅文档
            itemStyle: {
                color:'#62C467',
               
                 borderColor: '#ccc', // Set a border color for the bars
                borderWidth: 1,      // Set a border width for the bars
            },
    ...
    //set data
    option_pre_1.series = []
    d11 = bar1_datas[1].slice(0,3)
    d12 = Array(3).fill(0)
    console.log(d12)
    d11.push(...Array(bar1_datas[1].length-3).fill(0))
    console.log(d11)
    d12.push(...bar1_datas[1].slice(3))
    console.log(d12)
    option_pre_1.series.push({
            name: 'General Item',
            type: 'bar',
            data: d11,
            barWidth: 20,
