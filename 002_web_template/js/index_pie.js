...
function test(){document.getElementById("t1").innerHTML='test1'};
...
function mypie() {
        ...
        //mypie_data("data_test.csv", pie_platform.value, pie_software.value, pie_time.value);

        };



function mypie_data(file, platform, soft_version, date_week){
            d3.csv(file)
